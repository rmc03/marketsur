...
export function Home({ onAddToCart }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="sticky top-[60px] z-[50] bg-white/95 dark:bg-[#242526]/95 backdrop-blur-xl border-b border-slate-100 dark:border-[#3E4042] pb-2 shadow-sm rounded-b-2xl transition-colors duration-300">
