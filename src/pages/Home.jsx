...
export function Home({ onAddToCart }) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="sticky top-[56px] z-50 bg-white dark:bg-[#18191A] border-b border-slate-100 dark:border-[#3E4042] pb-2 shadow-sm rounded-b-2xl transition-colors duration-300">
