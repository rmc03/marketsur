...
export function FloatingCartButton({ cartCount, total, onOpenCart }) {
  ...
  return (
    <button
      onClick={onOpenCart}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#1877F2] hover:bg-[#166FE5] active:bg-[#145DBF] text-white pl-4 pr-5 py-3.5 rounded-full shadow-xl shadow-[#1877F2]/30 hover:shadow-2xl hover:shadow-[#1877F2]/40 transition-all duration-300 active:scale-95 animate-pop-in group"
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="relative bg-white/20 rounded-full p-2">
          <ShoppingCart className="w-5 h-5" weight="duotone" />
        </div>
        {/* Badge */}
